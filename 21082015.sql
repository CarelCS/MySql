...
INSERT INTO `tblstock` VALUES (1,'Rump Steak','Rump Steak','11',1,5),(2,'Buns','Hamburger Buns','15',3,5),(3,'J and B','J AND B','400',2,300),(4,'whiskey',NULL,'4000',0,300),(5,'srfsdfg',NULL,'1',0,1),(6,'Pasta',NULL,'10',1,5),(7,'JB Whiskey',NULL,'1000',2,50),(8,'JB Whiskey',NULL,'100',2,50);
...
BEGIN
	...
	(sStockName,sStockDescription,iStockLevel,FKiStockLevelTypeID,iStockLevelReplace)
	VALUES
	(sStockName,sStockDescription,iStockLevel,FKiStockLevelTypeID,iStockLevelReplace);
...
BEGIN
	UPDATE tblstock
	SET
	sStockName=insStockName,sStockDescription=insStockDescription,iStockLevel=iniStockLevel,FKiStockLevelTypeID=inFKiStockLevelTypeID,iStockLevelReplace=iniStockLevelReplace
...
-- Dump completed on 2015-08-21  9:59:05
