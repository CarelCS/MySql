...
CREATE TABLE `tblstock` (
  ...
  `sStockName` varchar(45) DEFAULT NULL,
  `sStockDescription` varchar(45) DEFAULT NULL,
  `iStockLevel` varchar(45) DEFAULT NULL,
  `FKiStockLevelTypeID` int(11) DEFAULT NULL,
  `iStockLevelReplace` int(11) DEFAULT NULL,
...
INSERT INTO `tblstock` VALUES (1,'Rump Steak','Rump Steak','11',1,5,NULL),(2,'Buns','Hamburger Buns','15',3,5,NULL),(3,'J and B','J AND B','400',2,300,NULL),(4,'whiskey',NULL,'4000',0,300,NULL),(5,'srfsdfg',NULL,'1',0,1,NULL),(6,'Pasta',NULL,'10',1,5,NULL),(7,'JB Whiskey',NULL,'1000',2,50,NULL),(8,'JB Whiskey',NULL,'100',2,50,NULL);
...
INSERT INTO `tblstockpermenuitem` VALUES (1,3,1,1),(2,1,2,1),(3,7,4,0),(4,7,5,0),(5,4,6,0),(6,8,7,0),(7,8,8,0);
...
IN insStockName VarChar(45),
IN insStockDescription VarChar(45),
IN iniStockLevel VarChar(45),
IN inFKiStockLevelTypeID Int(11),
IN iniStockLevelReplace Int(11),
IN iniQuantity Varchar(200)
)
BEGIN
	UPDATE tblstock
	SET
	iStockLevel=iniStockLevel-iniQuantity
...
BEGIN
	...
	(FKiMenuItem,FKiStockID,iStockAmount)
	VALUES
	(FKiMenuItem,FKiStockID,iStockAmount);
...
BEGIN
	...
	SET
	FKiMenuItem=inFKiMenuItem,FKiStockID=inFKiStockID,iStockAmount=iniStockAmount
...
IN sStockName VarChar(45),
IN sStockDescription VarChar(45),
IN iStockLevel VarChar(45),
IN FKiStockLevelTypeID Int(11),
IN iStockLevelReplace Int(11),
IN iQuantity Varchar(200),
OUT outPKiStockID INTEGER)
BEGIN
	INSERT INTO tblstock
	(sStockName,sStockDescription,iStockLevel,FKiStockLevelTypeID,iStockLevelReplace,iQuantity)
	VALUES
	(sStockName,sStockDescription,iStockLevel,FKiStockLevelTypeID,iStockLevelReplace,iQuantity);
...
-- Dump completed on 2015-08-23 18:54:28
